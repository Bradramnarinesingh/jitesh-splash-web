...
const AboutSection = () => {
  ...
  return (
    <section id="about" className="py-16 lg:py-24 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-ocean-50 wave-bg -z-10"></div>
      
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-bold text-ocean-900 mb-4">About Jitesh Wadhwa</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative">
            <div className="relative z-10">
              <img 
                src="https://images.unsplash.com/photo-1570440828843-0a575564a9b8?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" 
                alt="Jitesh Wadhwa" 
                className="rounded-2xl shadow-xl object-cover w-full h-[500px]"
              />
            </div>
            <div className="absolute -bottom-6 -right-6 w-2/3 h-2/3 bg-ocean-100 rounded-2xl -z-[1]"></div>
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
              {features.map((feature, index) => (
                <div key={index} className="glass-card p-5 flex flex-col items-center text-center">
                  <div className="mb-3">
                    {feature.icon}
                  </div>
                  <h4 className="text-lg font-semibold text-ocean-800 mb-2">{feature.title}</h4>
